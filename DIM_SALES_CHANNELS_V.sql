--------------------------------------------------------
--  DDL for View DIM_SALES_CHANNELS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIMS"."DIM_SALES_CHANNELS_V" ("SALES_CHANNEL_CODE", "SALES_CHANNEL_DESC", "AGENTGROUP_CODE", "AGENTGROUP_DESCRIPTION") AS 
