--------------------------------------------------------
--  DDL for View DIM_POSTCODES_G
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIMS"."DIM_POSTCODES_G" ("LAND_CODE", "LAND_DESCRIPTION", "PROV_CODE", "PROV_DESCRIPTION", "AREA_CODE", "AREA_DESCRIPTION", "POSTCODE_CODE", "POSTCODE_DESCRIPTION") AS 
  SELECT   "LAND_CODE",
            "LAND_DESCRIPTION",
            "PROV_CODE",
            "PROV_DESCRIPTION",
