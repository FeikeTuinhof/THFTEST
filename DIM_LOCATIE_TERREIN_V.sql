--------------------------------------------------------
--  DDL for View DIM_LOCATIE_TERREIN_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIMS"."DIM_LOCATIE_TERREIN_V" ("LOCATIEGROEP", "LOCATIE", "TERREIN", "CAR_PARK_NR", "DEVICE", "DEVICE_CODE", "DEVICE_NR", "NIVO", "NIVO_OMSCHRIJVING") AS 
