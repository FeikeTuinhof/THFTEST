--------------------------------------------------------
--  DDL for View DIM_CAR_PARKS_G
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIMS"."DIM_CAR_PARKS_G" ("CAP_CAR_PARK_NR", "CAP_DESCRIPTION", "CAP_CODE", "DEV_CODE", "DEV_DESCRIPTION", "DEV_SOURCE_CODE", "DEV_DEVICE_NR") AS 
